...
export class PayRunService {
  static async create(companyId: string, data: CreatePayRunInput) {
  ...
  static async generatePayslips(companyId: string, payRunId: string) {
  ...
  static async getById(companyId: string, payRunId: string) {
  ...
  static async update(companyId: string, payRunId: string, data: any) {
  ...
  static async delete(companyId: string, payRunId: string) {
