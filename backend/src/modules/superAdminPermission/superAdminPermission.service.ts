...
export class SuperAdminPermissionService {
  static async grantPermission(companyId: string, superAdminId: string, grantedBy: string) {
  ...
  static async revokePermission(companyId: string, superAdminId: string, revokedBy: string) {
  ...
  static async listGrantedPermissions(companyId: string, userId: string) {
  ...
  static async listSuperAdminPermissions(superAdminId: string) {
  ...
  static async checkPermission(superAdminId: string, companyId: string): Promise<boolean> {
    const permission = await prisma.superAdminPermission.findUnique({
      where: {
        superAdminId_companyId: {
          superAdminId,
